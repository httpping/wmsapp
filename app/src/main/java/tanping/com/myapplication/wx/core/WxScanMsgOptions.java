...
import tanping.com.myapplication.AppApplication;
import tanping.com.myapplication.wx.bean.DataType;
import tanping.com.myapplication.wx.bean.FileNameUtil;
import tanping.com.myapplication.wx.bean.FileType;
...
public class WxScanMsgOptions {
    ...
    public  boolean searchTencent(String rootDir,boolean isAllRefresh) {
        ...
        //搜索公用的下载数据
        searchDownload(lastWxUser,rootDir,isAllRefresh);
    ...
    public boolean searchWxUserDir(WxAccountInfo wxAccountInfo,boolean isAllRefresh){
        ...
        String wxName = wxAccountInfo.getFile_name();

        String rootDir = wxAccountInfo.getOrigin_file_path();
        //1、搜藏
